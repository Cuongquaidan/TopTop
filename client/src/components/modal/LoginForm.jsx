  ...
  return (
    <div className="bg-transparent rounded-xl relative w-full h-full overflow-hidden">
      <div className="p-6 px-2 h-full">
        <h2 className="text-center text-3xl font-bold mb-6 dark:text-white">
          Đăng nhập vào TikTok
        </h2>

        <div className="flex flex-col gap-3 max-h-[75%] px-2 overflow-auto scrollbar-track-white scrollbar-thin scrollbar-thumb-neutral-200 dark:scrollbar-track-neutral-800 dark:scrollbar-thumb-neutral-600">
        ...
        <p className="text-xs text-gray-500 dark:text-gray-400 text-center">
          ...
          <a href="#" className="text-blue-600 ml-1 dark:text-blue-400">
            Điều khoản dịch vụ
          </a>
          và
          <a href="#" className="text-blue-600 ml-1 dark:text-blue-400">
